...
data$hard_skill_groupings <- qdap::multigsub(HS11, "ProductAnalytics", data$hard_skill_groupings)
data$hard_skill_groupings <- qdap::multigsub(HS12, "WebAnalytics", data$hard_skill_groupings)
data$hard_skill_groupings <- qdap::multigsub(HS13, "OpensourceManagementSystems&Automations", data$hard_skill_groupings)
data$hard_skill_groupings <- qdap::multigsub(HS14, "CloudComputing", data$hard_skill_groupings)
data$hard_skill_groupings <- qdap::multigsub(HS15, "Agile", data$hard_skill_groupings)


hard_skill_levels <- c("DataModeling&DbSystems", "BusinessIntelligence", "API", "BusinessUnderstanding", "Statistics&AdvancedDataMining", "AI/ML", "ScriptingLanguages", "BusinessAnalytics&Reporting", "Algorithms", "Visualizations", "ProductAnalytics", "WebAnalytics", "OpensourceManagementSystems&Automations", "CloudComputing", "Agile" )
...
Soft_skills_levels <- c("Teamwork", "ProblemSolving", "Creativity", "WorkEthic", "InterpersonalSkills", "TimeManagement", "Leadership", "CommunicationSkills")
