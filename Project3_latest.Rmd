...
=======
data$soft_skills_2 <- as.character(lapply(data$soft_skills_2, gsub, pattern = "communicate", replacement = "communication skills", fixed = TRUE)) 

#data$soft_skills_2 <- as.character(lapply(data$soft_skills_2, gsub, pattern = "communication", replacement = "communication skills", fixed = TRUE))
>>>>>>> a3069682ce40a6d75305a2a2624d70d77f97acfe
