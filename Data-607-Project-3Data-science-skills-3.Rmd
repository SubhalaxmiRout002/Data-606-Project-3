...
From the map, we see number of highest oppertunity state for Data scientist and number of lowest opportunity for job in data science. The color volume dark means number of job post is high and color is white means very less job post.
